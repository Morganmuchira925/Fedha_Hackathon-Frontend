...
import { KES, COLORS } from "../constants";
import { generateData, renderCategoryIcon, renderSourceIcon } from "../utils";

const initialData = generateData();

export default function TransactionsPage() {
  const [recentTxns, setRecentTxns] = useState(initialData.transactions.slice(0, 20));
  const [activeFilter, setActiveFilter] = useState("All");

  // Dynamically filter transactions based on selected tab state
    ...
    <>
      <div style={{
        ...
        <p style={{
          ...
          {filteredTxns.length} records logged
        </p>
        <div style={{
          display: "flex",
          gap: 4,
      ...
      {/* Core Transaction Card Item rows */}
